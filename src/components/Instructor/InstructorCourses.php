...
<script>
    ...
    CloseButtonCoursesDelete.addEventListener('click', ()=> {
        ...
        function addCourse() {
            ...
            $.ajax({
                url: 'src/components/Instructor/Functions/AddCourse.php',
                type: 'POST',
        ...
        function DeleteCourse() {
                ...
                $.ajax({
                    url: 'src/components/Instructor/Functions/DeleteCourse.php',
                    type: 'POST',
        ...
        function EditCourse() {
                ...
                $.ajax({
                    url: 'src/components/Instructor/Functions/UpdateCourse.php',
                    type: 'POST',
